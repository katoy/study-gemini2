"""段階的訓練フェーズ 2: Negamax(6000ms) へ fine-tune。

フェーズ 1 で訓練済みのモデルから開始して、Negamax(6000ms) に対応。
"""
...
class TrainConfig:
    ...
    eval_games: int = 15
    board_size: int = 8
    warm_start: str = "models/alpha_zero_stage1_nega500.pth"
    best_model: str = "models/alpha_zero_nega6000.pth"
